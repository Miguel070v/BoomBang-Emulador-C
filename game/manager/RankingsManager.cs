...
namespace BoomBang.game.instances.manager
{
    class RankingsManager
    {
        ...
        public static void start_new_event(SalaInstance Sala)
        {
            ...
            string console = "[BoomBang Manager] -> Nuevo evento ha sido iniciado.";
        ...
        public static void end_event(SalaInstance Sala)
        {
            ...
            string console = "[BoomBang Manager] -> Ha terminado el evento semanal.";
            Emulator.Form.WriteLine(console);
        }
        public static void rankings_time_remove(SalaInstance Sala)
        {
            ...
            string console = "[BoomBang Manager] -> Ha terminado semanal de Minijuegos.";
            Emulator.Form.WriteLine(console);
        }
        static void recompenas_manager(SalaInstance Sala, bool tipo)// true > evento | false > juegos_semanales
        {
            ...
            if (tipo == true)
            {
                ...
                string console = "[BoomBang Manager] -> Los premios han sido entregados.";
                Emulator.Form.WriteLine(console);
            }
            if (tipo == false)
            {
                ...
                string console = "[BoomBang Manager] -> Los premios de Minijuegos han sido entregados.";
                Emulator.Form.WriteLine(console);
            }
        }
            ...
            foreach (var Sala in SalasManager.Salas_Publicas.Values)
            {
                if (count > 0)
                {
                   ...
                   "\rUsa comando /upper_semanal para ver el Ranking.");
                    ...
                    string console = "[BoomBang Manager] -> La noticia ha sido publicada.";
                    Emulator.Form.WriteLine(console);
                    count--;
                }
